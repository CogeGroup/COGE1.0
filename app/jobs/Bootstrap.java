...
//	}
 ...
 public void testCalcoloRicavoPerRapportoLavoro() throws ParseException{
 	...
 	System.out.println("calcolo:" + r1.calcolaRicavoPerTipoRapportoLavoro(7, 2011,tp1));
      ...
      Risorsa r1 = new Risorsa("admin","admin", "admin", new SimpleDateFormat("dd/MM/yyyy").parse("01/06/2011"));
      Risorsa r2 = new Risorsa("segreteria","segreteria", "segreteria",new SimpleDateFormat("dd/MM/yyyy").parse("01/06/2011"));
      ...
      Utente u1 = new Utente("admin",EncryptionUtility.encrypt("admin"),true);
...
//      
      ...
      Utente u2 = new Utente("segreteria",EncryptionUtility.encrypt("segreteria"),true);
      u2.addRuolo(ruolo2);
      ...
      public void setupGeek() throws ParseException{
    	  TipoStatoRisorsa tipoStatRis = new TipoStatoRisorsa("IN","ingresso").save();
    	  tipoStatRis = new TipoStatoRisorsa("Uscita","OUT").save();
    	  tipoStatRis = new TipoStatoRisorsa("Trasferminto Rapporto","TRAS").save();
    	  tipoStatRis = new TipoStatoRisorsa("Sospeso","SOSP").save();
    	  tipoStatRis = new TipoStatoRisorsa("Chiuso","CHIUSO").save();
    	  tipoStatRis = new TipoStatoRisorsa("Attivo","ATTIVO").save();
        
    	Risorsa r1 = new Risorsa("admin","admin", "admin", new SimpleDateFormat("dd/MM/yyyy").parse("01/06/2011"));
    	r1.tipoStatoRisorsa = tipoStatRis;
    	r1.save();
        Risorsa r2 = new Risorsa("segreteria","segreteria", "segreteria",new SimpleDateFormat("dd/MM/yyyy").parse("01/06/2011"));
        r2.tipoStatoRisorsa = tipoStatRis;
        r2.save();
