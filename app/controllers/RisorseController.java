...
//    	TipoRapportoLavoro tipoRapportoLavoro = ra != null ? ra.tipoRapportoLavoro : null;
    ...
    public static void export() {
		...
		try {
	        ...
	        Cell cogn = row.createCell(2);
	        cogn.setCellStyle(style);
	        cogn.setCellValue("COGNOME");
	        Cell dn = row.createCell(3);
	        dn.setCellStyle(style);
	        dn.setCellValue("DATA DI NASCITA");
	        Cell cf = row.createCell(4);
	        cf.setCellStyle(style);
	        cf.setCellValue("CODICE FISCALE");
	        Cell din = row.createCell(5);
	        din.setCellStyle(style);
	        din.setCellValue("DATA IN");
	        Cell dout = row.createCell(6);
	        dout.setCellStyle(style);
	        dout.setCellValue("DATA OUT");
	        Cell rl = row.createCell(7);
	        rl.setCellStyle(style);
	        rl.setCellValue("RAPPORTO LAVORATIVO");
	        Cell liv = row.createCell(8);
	        liv.setCellStyle(style);
	        liv.setCellValue("LIVELLO CCNL");
	        ...
	        for(Risorsa risorsa : listaRisorse){
		        ...
		        row.createCell(4).setCellValue(risorsa.codiceFiscale);
		        row.createCell(5).setCellValue(MyUtility.dateToString(risorsa.dataIn));
		        row.createCell(6).setCellValue(risorsa.dataOut == null ? null : MyUtility.dateToString(risorsa.dataOut));
		        RapportoLavoro rapLav = RapportoLavoro.findByRisorsaAndData(risorsa, new Date());
